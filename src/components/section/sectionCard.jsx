...
//aos stylesheet import
import 'aos/dist/aos.css';


//image import
import Frontend from '../../icons/frontend-icon.svg';
import Backend from '../../icons/backend-icon.svg';
import Other from '../../icons/other-skills-icon.svg';
            ...
            <div className="row">
              ...
              <div className="Card" data-aos="fade-up">
                <div className="skillData">
                  <h4>Backend</h4>
                  <div className="skillIcon">
                    <img src={Backend} alt="backend" style={{transform : 'translate(65%, 40%)'}} />
                  </div>
                  <ul className="skillList">
                    <li>
                      <svg width="1em" height="1em" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M173.898 439.404l-166.4-166.4c-9.997-9.997-9.997-26.206 0-36.204l36.203-36.204c9.997-9.998 26.207-9.998 36.204 0L192 312.69 432.095 72.596c9.997-9.997 26.207-9.997 36.204 0l36.203 36.204c9.997 9.997 9.997 26.206 0 36.204l-294.4 294.401c-9.998 9.997-26.207 9.997-36.204-.001z"></path></svg>
              ...
              <div className="Card" data-aos="fade-up">
                <div className="skillData">
                  <h4>Others</h4>
                  <div className="skillIcon">
                    <img src={Other} alt="Other" style={{transform: 'translate(40%, 45%)'}} />
                  </div>
                  <ul className="skillList">
                    <li>
                        <svg width="1em" height="1em" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M173.898 439.404l-166.4-166.4c-9.997-9.997-9.997-26.206 0-36.204l36.203-36.204c9.997-9.998 26.207-9.998 36.204 0L192 312.69 432.095 72.596c9.997-9.997 26.207-9.997 36.204 0l36.203 36.204c9.997 9.997 9.997 26.206 0 36.204l-294.4 294.401c-9.998 9.997-26.207 9.997-36.204-.001z"></path></svg>
